...
public class Settings extends PreferenceActivity implements ButtonBarHandler {
    ...
    public static class StatusBarClockActivity extends Settings { /* empty */ }
    public static class LockscreenChooserActivity extends Settings { /* empty */ }
    public static class InterfaceSettings extends Settings { /* empty */ }
